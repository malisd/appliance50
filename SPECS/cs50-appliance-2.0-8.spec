...
Requires: garcon, gdm, httpd, iptables, mod_suphp, mysql-server, nano, openssh-server, php, phpMyAdmin, proftpd, rsnapshot, setup, sudo, teamviewer6, usermin, vim, webmin, xfce4-panel
BuildArch: i386
...
/bin/cat > /etc/motd <<"EOF"
 ...
 | (__\__ \___) | |_| | | (_| | |_) | |_) | | | (_| | | | | (_|  __/
  \___|___/____/ \___/   \__,_| .__/| .__/|_|_|\__,_|_| |_|\___\___| 2.0-8
                              |_|   |_|
                                             This is CS50. In a box.
...
# /etc/my.cnf
/bin/cp -a /etc/my.cnf /etc/my.cnf.rpmsave
...
/usr/bin/mysql --user=root 2> /dev/null <<"EOF"
...
# jharvard, etc.
/usr/bin/mysql --force --user=root --password=crimson 2> /dev/null <<"EOF"
DROP USER ''@'%';
DROP USER ''@'localhost';
...
/bin/cp -a /etc/webmin/proftpd/config /etc/webmin/proftpd/config.rpmsave
