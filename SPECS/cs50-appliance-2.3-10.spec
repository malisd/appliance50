...
/usr/bin/rsync --archive --backup --links --quiet --suffix=.rpmsave /etc/skel/{.config,.local,.mozilla} /home/jharvard/
/bin/chown -R jharvard:students /home/jharvard/{.config,.local,.mozilla}
/usr/bin/rsync --archive --backup --links --quiet --suffix=.rpmsave /etc/skel/{.config,.local,.mozilla} /root/
...
echo "   Updated John Harvard's desktop."
