...
Version=1.0
Type=Application
Exec=firefox https://manual.cs50.net/CS50_Appliance
Icon=help-contents
StartupNotify=false
Terminal=false
Categories=CS50;
...
/bin/cat > /usr/share/applications/cs50-2009-fall.desktop <<"EOF"
[Desktop Entry]
Version=1.0
Type=Application
Exec=firefox https://manual.cs50.net/Fall_2009
Icon=help-contents
StartupNotify=false
Terminal=false
Categories=CS50;
...
/bin/sed -i "/^\$cfg\['Servers'\]\[\$i\]\['hide_db'\]    = '';$/s/''/'information_schema|mysql|performance_schema'/" /etc/phpMyAdmin/config.inc.php
