...
Requires: garcon, gdm, httpd, iptables, mod_suphp, mysql-server, nano, openssh-server, php, phpMyAdmin, rsnapshot, setup, sudo, teamviewer6, usermin, vim, webmin, xfce4-panel
BuildArch: i386


############################################################################
%description
The CS50 Appliance is a virtual machine that lets you "take" CS50,
even if you're not a student at Harvard.
...
# /etc/banner
/bin/cp -a /etc/banner /etc/banner.rpmsave
...
# /etc/motd
# http://www.network-science.de/ascii/ascii.php?TEXT=cs50+appliance&x=34&y=10&FONT=ogre&RICH=no&FORM=left&STRE=no&WIDT=80
/bin/cp -a /etc/motd /etc/motd.rpmsave
/bin/cat > /etc/motd <<"EOF"
 ...
 | (__\__ \___) | |_| | | (_| | |_) | |_) | | | (_| | | | | (_|  __/
  \___|___/____/ \___/   \__,_| .__/| .__/|_|_|\__,_|_| |_|\___\___| 2.0-6
                              |_|   |_|
                                             This is CS50. In a box.
...
/bin/cp -a /etc/profile.d/cs50.sh /etc/profile.d/cs50.sh.rpmsave
...
/bin/cp -a /etc/sysconfig/network /etc/sysconfig/network.rpmsave
...
/bin/cp -a /etc/sysconfig/network-scripts/ifcfg-eth0 /etc/sysconfig/network-scripts/ifcfg-eth0.rpmsave
...
/bin/cp -a /etc/sysconfig/network-scripts/ifcfg-eth1 /etc/sysconfig/network-scripts/ifcfg-eth1.rpmsave
...
/bin/cp -a /etc/sysconfig/network-scripts/ifcfg-eth2 /etc/sysconfig/network-scripts/ifcfg-eth2.rpmsave
...
/bin/cp -a /etc/xdg/menus/xfce-applications.menu /etc/xdg/menus/xfce-applications.menu.rpmsave
...
/bin/cp -a /etc/httpd/conf/httpd.conf /etc/httpd/conf/httpd.conf.rpmsave
...
/bin/cp -a /etc/sysconfig/iptables /etc/sysconfig/iptables.rpmsave
...
# /etc/suphp.conf
/bin/cp -a /etc/suphp.conf /etc/suphp.conf.rpmsave
...
/bin/cp -a /etc/httpd/conf.d/mod_suphp.conf /etc/httpd/conf.d/mod_suphp.conf.rpmsave
...
/usr/bin/mysqladmin -s --user=root password crimson

/usr/bin/mysql -u root 2> /dev/null <<"EOF"
DROP USER ''@'%';
EOF
...
# /etc/nanorc
/bin/cp -a /etc/nanorc /etc/nanorc.rpmsave
...
/sbin/service sshd restart > /dev/null
...
# /etc/php.ini
/bin/cp -a /etc/php.ini /etc/php.ini.rpmsave
...
/bin/cp -a /etc/httpd/conf.d/phpMyAdmin.conf /etc/httpd/conf.d/phpMyAdmin.conf.rpmsave
...
/bin/cp -a /etc/phpMyAdmin/config.inc.php /etc/phpMyAdmin/config.inc.php.rpmsave
/bin/cat > /etc/phpMyAdmin/config.inc.php <<"EOF"
<?php
/*
 * Generated configuration file
 * Generated by: phpMyAdmin 3.4.2 setup script
 * Date: Wed, 13 Jul 2011 22:22:15 -0400
 */
...
# /etc/rsnapshot.conf
/bin/cp -a /etc/rsnapshot.conf /etc/rsnapshot.conf.rpmsave
...
# /etc/hosts
/bin/cp -a /etc/hosts /etc/hosts.rpmsave
...
# /etc/sudoers
/bin/cp -a /etc/sudoers /etc/sudoers.rpmsave
...
/bin/cp -a /etc/usermin/miniserv.conf /etc/usermin/miniserv.conf.rpmsave
/bin/sed -i -e 's/^ssl=1/ssl=0/' /etc/usermin/miniserv.conf

# /etc/usermin/changepass/config
/bin/cp -a /etc/usermin/changepass/config /etc/usermin/changepass/config.rpmsave
/bin/sed -i -e 's/^passwd_cmd=file/passwd_cmd=/' /etc/usermin/changepass/config

# /etc/usermin/webmin.acl
/bin/cp -a /etc/usermin/webmin.acl /etc/usermin/webmin.acl.rpmsave
...
# /etc/vimrc
/bin/cp -a /etc/vimrc /etc/vimrc.rpmsave
...
/bin/cp -a /etc/webmin/miniserv.conf /etc/webmin/miniserv.conf.rpmsave
...
/bin/cp -a /etc/xdg/xfce4/panel/default.xml /etc/xdg/xfce4/panel/default.xml.rpmsave
...
/usr/bin/rsync --delete --copy-links --recursive /etc/skel/.config/xfce4/panel/* /root/.config/xfce4/panel/

# /root/.config/xfce4/xfconf/
/bin/mkdir -p /root/.config/xfce4/xfconf/
/usr/bin/rsync --delete --copy-links --recursive /etc/skel/.config/xfce4/xfconf/* /root/.config/xfce4/xfconf/
